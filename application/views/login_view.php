...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/perpus2.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: yellow;font-size: 50px;">Sistem Informasi <br/><b>Perpustakaan</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Sistem Perpustakaan SD Kanisius - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
