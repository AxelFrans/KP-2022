					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								...
								<input type="text" name="kategori"  value="<?=$kat->nama_kategori;?>" id="kategori" class="form-control"  placeholder="Contoh : Koleksi Cerita Anak" >
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								<div class="form-group">
								<label for="">Nama Kategori</label>
								<input type="text" name="kategori" id="kategori" class="form-control" placeholder="Contoh : Koleksi Cerita Anak" >
