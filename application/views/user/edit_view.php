                        ...
                        <form action="<?php echo base_url('user/upd'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label>NISN</label>
                                        <input type="text" class="form-control" value="<?= $user->nisn; ?>" name="nisn" placeholder="NISN">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Kelas</label>
                                        <input id="uintTextBox" class="form-control" value="<?= $user->kelas; ?>" name="kelas" placeholder="Contoh : 1 - 6">
                                    </div>
