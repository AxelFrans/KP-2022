                        ...
                        <form action="<?php echo base_url('user/add'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label>NISN</label>
                                        <input type="text" class="form-control" name="nisn" required="required" placeholder="NISN">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label>Kelas</label>
                                        <input id="uintTextBox" class="form-control" name="kelas" placeholder="Contoh : 1 atau 6 (kosongkan jika petugas) ">
                                    </div>
