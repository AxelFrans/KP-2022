                                            ...
                                            <td>
                                                <center>
                                                    <?php if (!empty($isi['foto'] !== "-")) { ?>
                                                        <img src="<?php echo base_url(); ?>assets_style/image/<?php echo $isi['foto']; ?>" alt="" onerror="this.src='<?php echo base_url('assets_style/image/empy-prof.jpeg'); ?>';" class="img-responsive" style="height:auto;width:100px;" />
                                                    <?php } else { ?>
