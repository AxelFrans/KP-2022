										...
										<tr>
											...
											<td>
												<div class="input-group">
													<input type="text" class="form-control" required autocomplete="off" name="nisn" id="search-box" placeholder="NISN" type="text" value="">
						...
						foreach ($buku->result_array() as $isi) { ?>
							<tr>
								...
								<td style="width:17%">
									...
									<?php if ($jumlah == 0) { ?>
										<button class="btn btn-primary" id="Select_File2" data_id="<?= $isi['buku_id']; ?>" disabled>
					...
					<tbody>
						...
						?>
								<tr>
									...
									<td><?= $isi['level']; ?></td>
									<td style="width:20%;">
										<button class="btn btn-primary" id="Select_File1" data_id="<?= $isi['nisn']; ?>">
											<i class="fa fa-check"> </i> Pilih
										</button>
									</td>
								</tr>
