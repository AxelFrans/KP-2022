                                            ...
                                            <td>
                                                <center>
                                                    <?php if (!empty($isi['sampul'] !== "0")) { ?>
                                                        <img src="<?php echo base_url(); ?>assets_style/image/buku/<?php echo $isi['sampul']; ?>" alt="Tidak Ada Sampul" onerror="this.src='<?php echo base_url('assets_style/image/sampul-kosong.png'); ?>';" class="img-responsive" style="height:auto;width:100px;" />
                                                    <?php } else { ?>
