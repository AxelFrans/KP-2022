    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                ...
                ?>
                    <br />
                    <img src="<?php echo base_url(); ?>assets_style/image/<?php echo $d->foto; ?>" alt="#" c lass="user-image" style="border:2px solid #fff;height:auto;width:100%;" onerror="this.src='<?php echo base_url('assets_style/image/empy-prof.jpeg'); ?>';" />
                <?php } else { ?>
